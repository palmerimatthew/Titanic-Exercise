...
Cabin starts with 'A' at the top of the ship down to 'G' at the bottom of the ship. There is some cabins with higher survivorship, but it doesn't make logical sense with the relative locations of the cabins to the lifeboat locations (A only at 47% but B is at 74%). Some digging might be needed to see if these differences are due to other factors other than the cabin location (maybe a lot of first class rooms were in cabin B for example).
